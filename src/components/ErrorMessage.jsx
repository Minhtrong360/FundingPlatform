      ...
      <div className="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div className="relative inline-block px-4 pt-5 pb-4 overflow-hidden text-left align-bottom transition-all transform bg-white rounded-md shadow-xl rtl:text-right darkBg sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6">
          ...
          <div className="mt-5 sm:flex sm:items-center sm:justify-center">
            <button
              onClick={onCancel}
              className="w-full px-3 py-2 mt-2 text-sm font-medium tracking-wide text-gray-700 capitalize transition-colors duration-300 transform border border-gray-300 rounded-md sm:mt-0 sm:w-auto sm:mx-2 darkTextGray -gray-700 darkHoverBgBlue hover:bg-gray-100 focus:outline-none focus:ring focus:ring-gray-300 focus:ring-opacity-40"
            >
              Cancel
            </button>
