    ...
    >
      ...
      <div className="mt-16 mx-auto flex flex-col items-start h-full px-3 py-4 space-y-2 overflow-y-auto">
        <button
          ...
          onClick={() => navigate("/")}
        >
          <img width="18" height="18" src="https://img.icons8.com/ios/50/home--v1.png" alt="home--v1"/>
        ...
        >
          <img width="18" height="18" src="https://img.icons8.com/ios/50/user--v1.png" alt="user--v1"/>
        ...
        >
         <img width="18" height="18" src="https://img.icons8.com/ios/50/control-panel--v2.png" alt="control-panel--v2"/>
        ...
        >
          <img width="18" height="18" src="https://img.icons8.com/ios/50/investment.png" alt="investment"/>
        ...
        >
          <img width="18" height="18" src="https://img.icons8.com/ios/50/folder-invoices--v1.png" alt="folder-invoices--v1"/>
