...
const Trial = () => {
  ...
  return (
    <form className="max-w-4xl p-6 mx-auto bg-white rounded-md shadow-md darkBgBlue">
      ...
      <button
        type="button"
        className={`flex justify-center text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2 text-center darkBgBlue darkHoverBgBlue darkFocus`}
        onClick={handleBack}
      >
        Back to project
      </button>
