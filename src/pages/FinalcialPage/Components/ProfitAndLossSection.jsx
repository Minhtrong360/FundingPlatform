  ...
  const positionColumns = [
    {
      ...
      fixed: "left",
      render: (text, record) => ({
        children: <a style={{ fontWeight: (record.metric === " Operating Activities " || record.metric === " Investing Activities " || record.metric === " Financing Activities ") ? 'bold' : 'normal' }}>{text}</a>,
        props: {
