  ...
  function Card({ icon, title, metric, description, badgeText }) {
    return (
      <div className="text-left w-full h-full bg-white shadow-lg rounded-lg p-5 dark:bg-slate-900">
        ...
        <h3 className="text-3xl font-bold text-black-600 dark:text-gray-400">{metric}</h3>
      ...
      <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 items-center gap-6 md:gap-10">
          ...
          <Card
            ...
            description="Get your goods in front of millions of potential customers with ease."
            badgeText="New"
          />
          {/* End Card 3 */}
