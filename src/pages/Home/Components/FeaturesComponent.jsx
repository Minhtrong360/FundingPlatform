...
//           G
//           <span className="mt-5">
//             <span className="hs-tab-active:text-blue-600 block font-semibold text-gray-800 dark:hs-tab-active:text-blue-500 dark:text-gray-200">All-in-one workspace</span>
...
//                 <span className="size-2 bg-gray-200 rounded-full dark:bg-gray-700"></span>
//               </div>
//               <div className="flex justify-center items-center size-full bg-gray-200 text-[.25rem] text-gray-800 rounded-sm sm:text-[.5rem] dark:bg-gray-700 dark:text-gray-200">www.preline.co</div>
//             </div>
  ...
  return (
    <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
      ...
      <nav className="max-w-6xl mx-auto grid sm:flex gap-y-px sm:gap-y-0 sm:gap-x-4" aria-label="Tabs" role="tablist">
        ...
        <button
          type="button"
          className={`hs-tab-active:bg-gray-100 hs-tab-active:hover:border-transparent w-full flex flex-col text-start hover:bg-gray-100 p-3 md:p-5 rounded-xl dark:hs-tab-active:bg-white/[.05] dark:hover:bg-gray-700 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600 ${activeTab === 1 ? 'hs-tab-active:bg-gray-100' : ''}`}
        ...
        >
          ...
          <span className="mt-5">
            <span className={`block font-semibold text-gray-800 ${activeTab === 1 ? 'hs-tab-active:text-blue-600 dark:hs-tab-active:text-blue-500' : 'dark:text-gray-200'}`}>All-in-one workspace</span>
            <span className="hidden lg:block mt-2 text-gray-800 dark:text-gray-200">Create a business, whether you’ve got a fresh idea.</span>
          </span>
        </button>
        ...
        >
          ...
          <span className="mt-5">
            <span className={`block font-semibold text-gray-800 ${activeTab === 2 ? 'hs-tab-active:text-blue-600 dark:hs-tab-active:text-blue-500' : 'dark:text-gray-200'}`}>Automation on a whole new level</span>
            <span className="hidden lg:block mt-2 text-gray-800 dark:text-gray-200">Use automation to scale campaigns profitably and save time doing it.</span>
          </span>
        </button>
        ...
        >
          ...
          <span className="mt-5">
            <span className={`block font-semibold text-gray-800 ${activeTab === 3 ? 'hs-tab-active:text-blue-600 dark:hs-tab-active:text-blue-500' : 'dark:text-gray-200'}`}>Solving problems for every team</span>
            <span className="hidden lg:block mt-2 text-gray-800 dark:text-gray-200">One tool for your company to share knowledge and ship projects.</span>
          </span>
        </button>
      </nav>
