      ...
      <div className="grid grid-cols-1 md:grid-cols-3 items-center gap-5 text-center">
        ...
        <ul className="text-center">
          <li className="inline-block relative pe-8 last:pe-0 last-of-type:before:hidden before:absolute before:top-1/2 before:end-3 before:-translate-y-1/2 before:content-['/'] before:text-gray-300 darkBeforeTextGray">
            <a
              className="inline-flex gap-x-2 text-sm text-gray-800 hover:text-blue-600 darkTextGray darkHoverTextWhite darkFocusOutlineNone darkFocusRing-1 darkFocus"
              href="#"
            >
              About
            </a>
          ...
          <li className="inline-block relative pe-8 last:pe-0 last-of-type:before:hidden before:absolute before:top-1/2 before:end-3 before:-translate-y-1/2 before:content-['/'] before:text-gray-300 darkBeforeTextGray">
            <a
              className="inline-flex gap-x-2 text-sm 8 hover:text-blue-600 darkTextGray darkHoverTextWhite darkFocusOutlineNone darkFocusRing-1 darkFocus"
              href="#"
            >
              Services
            </a>
