...
const policies = [
  {
    ...
    content: (
      <div>
        ...
        <ol>
          <li>
            Select the appropriate service package and click "Purchase" and fill
            in the service account registration information with email (if you
            have not registered BeeKrowd)
          </li>
          <li>
  ...
  },
  {
    ...
    content: (
      <div>
        ...
        <ol>
          <h2>
            1. If the service registration is successful but not usable within 3
            days, please contact us via phone, email, website for a resolution
            or refund within 15 working days.
          </h2>
          <h2>
            2. We commit to using all measures to secure customer documents and
            images collected and only use them for storage, complaint
          ...
          <h2>
            ...
            <ul>
              ...
              <li>
                The service is suspended or terminated due to BeeKrowd's error.
              </li>
            </ul>
            ...
            within 3 days from the date you receive the service. The processing
            time for returns and warranties is a maximum of 11 days from the
            date of receiving your request.
          </h2>
          <li>
          ...
          <h4>
            ...
            text on the website, send an email, or call the hotline and provide
            your name, phone number, or order code to be checked and supported
            as soon as possible.
          </h4>
        </ol>
      </div>
...
const Vipolicies = [
  {
    ...
    content: (
      <div className="policy-content">
        ...
        <p>
          Giá dịch vụ niêm yết tại Website là giá đã bao gồm thuế theo quy định
          pháp luật hiện hành và các chi phí khác liên quan đến việc mua dịch vụ
          trừ các chi phí phát sinh khác được xác nhận qua Hotline hoặc Email
          của BeeKrowd và được sự chấp thuận của khách hàng trong quá trình xác
          nhận, giao nhận dịch vụ.
        </p>
      </div>
    ),
  },
      ...
      <div>
        ...
        <ol>
          <li>
            ...
            Các đối tác trên website beekrowd.com là các cá nhân, tổ chức, nhà,
            khách sạn, công ty… trong và ngoài nước mua dịch vụ từ BeeKrowd.
          </li>
          <li>
            Các cá nhân, tổ chức, công ty… trong và ngoài nước khi mua dịch vụ
            được phép thỏa thuận trên cơ sở tôn trọng quyền và lợi ích hợp pháp
            của các bên tham gia hoạt động mua bán dịch vụ, thông qua phiếu đăng
            kí hoặc hợp đồng dịch vụ không trái với quy định của pháp luật nước
            Cộng hòa xã hội chủ nghĩa Việt Nam.
          </li>
          <li>
            Các cá nhân, tổ chức, công ty… mua dịch vụ phải đáp ứng đầy đủ các
            quy định của pháp luật có liên quan, không thuộc các trường hợp cấm
        ...
        <ol>
          ...
          <li>
            ...
            Internet có thể ảnh hưởng đến tốc độ truy cập của quý khách hàng vào
          ...
          <li>
            ...
            BeeKrowd. Chúng tôi không chịu trách nhiệm về các thiệt hại hay mất
            mát phát sinh từ các giao dịch được thực hiện trái phép bằng tài
            khoản của quý khách hàng.
          </li>
          <li>
            Nếu phát hiện thông tin giả mạo từ tài khoản của quý khách hàng trên
            website, chúng tôi sẽ ngay lập tức khóa tài khoản và/hoặc thực hiện
    ...
    content: (
      <div>
        ...
        <p>
          ...
          các bên thứ ba thông qua các đơn vị dịch vụ trung gian.
        </p>
        <p>
        ...
        <p>
          Xác minh và nhận diện: BeeKrowd sử dụng thông tin của bạn để xác minh,
          đánh giá pháp lý hoặc để nhận biết khách hàng.
        </p>
        <p>
          Nghiên cứu và phát triển: BeeKrowd sử dụng thông tin của bạn để lập số
          liệu thống kê, nghiên cứu nhằm duy trì sổ sách nội bộ hoặc nhằm mục
          đích phát triển, nâng cao chất lượng phục vụ khách hàng.
        </p>
        <p>
          Tuân thủ pháp luật: BeeKrowd sử dụng thông tin của bạn để đáp ứng các
          thủ tục pháp lý hoặc các yêu cầu của cơ quan nhà nước có thẩm quyền
          khi được yêu cầu mà việc tiết lộ thông tin là cần thiết, đúng với pháp
          luật.
        </p>
        <p>
          Mục đích khác: BeeKrowd có thể thu thập, sử dụng, xử lý dữ liệu cá
          nhân của bạn phụ thuộc vào từng hoàn cảnh cụ thể mà mục đích đó có thể
          không được liệt kê ở trên. Tuy nhiên, BeeKrowd sẽ thông báo cho bạn về
        ...
        <p>
          ...
          cập vào thông tin cá nhân của bạn khi cần thiết để thực hiện chức
          trách công việc của họ.
        </p>
        <p>
          Đối tác của BeeKrowd: BeeKrowd có thể chia sẻ thông tin cá nhân của
          bạn với các đối tác của chúng tôi là các đơn vị dịch vụ trung gian như
          dịch vụ vận chuyển, dịch vụ thanh toán trung gian hoặc theo lệnh của
          tòa án hay bất kỳ cơ quan nhà nước có thẩm quyền nhằm (i) tuân thủ quy
          định của pháp luật; (ii) thực thi nghĩa vụ theo các điều khoản quy
          định tại hợp đồng/giao dịch; (iii) đáp ứng các yêu cầu của bạn về dịch
          vụ khách hàng; (iv) bảo vệ quyền, tài sản hoặc sự an toàn của chúng
          tôi và của bạn.
        </p>
        <p>
          Cơ quan nhà nước có thẩm quyền: BeeKrowd sẽ cung cấp thông tin cá nhân
        ...
        <p>
          ...
          thập thông tin cá nhân cơ bản như họ tên, địa chỉ email, số điện thoại
        ...
        <p>
          Các trường hợp trên không nhằm mục đích liệt kê đầy đủ các trường hợp
        ...
        <p>
          ...
          khoản ngân hàng và thông tin thanh toán, số điện thoại, hình ảnh, âm
          thanh, và các thông tin khác về người dùng khi bạn đăng nhập để sử
          dụng các dịch vụ liên kết chính thống tại Website của chúng tôi hoặc
          bất kỳ thông tin nào mà chúng tôi đã yêu cầu và được bạn cho phép cung
          cấp.
        </p>
        <p>
          b. Nếu bạn không muốn chúng tôi thu thập thông tin/dữ liệu cá nhân như
          đã nêu, bạn có quyền không cung cấp thông tin hoặc rút lại sự cho phép
          bằng cách thông báo bằng văn bản hoặc qua email đến chúng tôi. Tuy
          nhiên, việc từ chối hoặc hủy bỏ cho phép chúng tôi thu thập, sử dụng
          hoặc xử lý dữ liệu cá nhân của bạn có thể làm ảnh hưởng đến giao dịch
          của bạn với chúng tôi và/hoặc hạn chế việc bạn sử dụng các dịch vụ với
          nền tảng được liên kết tại Website.
        </p>
        <p>
          c. Chúng tôi không cố ý thu thập thông tin cá nhân dưới 18 tuổi mà
          không có sự kiểm soát của cha mẹ hoặc người giám hộ hợp pháp. Nếu bạn
          dưới 18 tuổi, xin vui lòng không cung cấp cho chúng tôi bất kỳ thông
          tin cá nhân nào. Nếu chúng tôi phát hiện thông tin cá nhân của người
          dùng dưới 18 tuổi đã được cung cấp mà không có sự kiểm soát của người
        ...
        <p>
          ...
          nhân của bạn sẽ được lưu trữ trên các mạng bảo mật và chỉ có thể truy
          cập bởi một số nhân viên được cấp quyền truy cập đặc biệt. Tuy nhiên,
          chúng tôi không thể cam kết an ninh tuyệt đối do sự xuất hiện của các
          sự cố bất ngờ. Trong trường hợp có sự cố xảy ra, chúng tôi sẽ nỗ lực
          hết mình để khắc phục và giảm thiểu rủi ro.
        </p>
        <p>
          b. Chúng tôi cam kết duy trì dữ liệu cá nhân của bạn đúng theo quy
          định pháp luật. Nếu cần thiết và theo phạm vi cho phép của pháp luật,
        ...
        <p>
          ...
          mềm, hình ảnh, video, âm nhạc, âm thanh, biên dịch phần mềm, mã nguồn
        ...
        <p>
          b. Để xoá tài khoản và hủy bỏ toàn bộ thông tin cá nhân và lịch sử mua
        ...
        <p>
          ...
          dụng sai mục đích, vui lòng liên hệ qua các kênh sau để được giải đáp
          và hỗ trợ:
        </p>
        <p>Website: https://www.beekrowd.com</p>
        ...
        <ol>
          ...
          <li>
            <h4 className="my-4">
              ...
              mục đích được cho là đúng pháp luật và cần thiết mà không sử dụng
              cho mục đích thương mại hay vụ lợi khác.
            </h4>
          </li>
          <li>
            <h4 className="my-4">
            ...
            <p className="mt-2">
              ...
              dịch vụ. Thời gian xử lý hoàn trả, bảo hành được thực hiện tối đa
