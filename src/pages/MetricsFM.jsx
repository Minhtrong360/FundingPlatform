  ...
  <div className="p-4 md:p-5">
    ...
    <div className="mt-1 flex items-center gap-x-2 flex-wrap">
      <h3 className="text-sm sm:text-3xl font-bold text-gray-800 my-2">
        {formatNumber(Math.round(yearlyAverageCustomers[0], 2))}000000
      </h3>
      <span className="flex items-center gap-x-1 text-green-600 ml-2">
        ...
        <Tooltip title="The increase percentage of the second year compared to the first year in the series.">
          <span className="inline-block text-sm">
            {((yearlyAverageCustomers[1] - yearlyAverageCustomers[0]) * 100) /
...
<div className="flex flex-col bg-white border shadow-sm rounded-xl">
  <div className="p-4 md:p-5">
    ...
    <div className="mt-1 flex items-center gap-x-2 flex-wrap">
      <div className="flex flex-col xl:flex-row xl:items-center items-start flex-wrap">
      <h3 className="text-sm sm:text-3xl font-bold text-gray-800 my-2 truncate">
          {new Intl.NumberFormat("en-US", {
            style: "currency",
            currency: "USD",
            minimumFractionDigits: 0,
            maximumFractionDigits: 0,
          }).format(Math.round(yearlySales[0] ? yearlySales[0] : 0))}000000000
        </h3>
        <span className="flex items-center gap-x-1 text-green-600 ml-2">
          <svg
            className="inline-block size-4 self-center"
