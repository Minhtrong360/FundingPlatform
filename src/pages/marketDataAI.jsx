...
function MarketDataAI() {
  ...
  return (
    <div className="flex items-start justify-center  px-4 pt-4  text-center sm:block sm:p-0">
      <div className="relative inline-block px-4 pt-5 pb-4 overflow-hidden text-left align-bottom transition-all transform bg-white rounded-md shadow-xl darkBg sm:my-8 sm:w-full sm:max-w-sm sm:p-6 sm:align-middle">
        <h3
        ...
        <form className="mt-4">
          <label className="block mt-3" htmlFor="email">
            <input
              ...
              className="block w-full px-4 py-3 text-sm text-gray-700 bg-white border border-gray-300 rounded-md focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40 darkBorderGray darkBg darkTextGray darkFocusBorder"
            />
          </label>
          ...
          <div className="mt-4 sm:flex sm:items-center sm:-mx-2">
            <button
              ...
              className="w-full px-3 py-2 text-sm font-medium tracking-wide text-gray-700 capitalize transition-colors duration-300 transform border border-gray-300 rounded-md sm:w-1/2 sm:mx-2 darkTextGray darkBorderGray darkHoverBgBlue hover:bg-gray-100 focus:outline-none focus:ring focus:ring-gray-300 focus:ring-opacity-40"
            >
              Cancel
            </button>
            ...
            <button
              ...
              disabled={isLoading ? true : false}
              className={`w-full px-3 py-2 mt-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform ${
