	...
	return (
		<>
			<Routes>
				...
				<Route key={location.key} path="/coming-soon" element={<ComingSoonPage />} />
				<Route key={location.key} path="/contact-us" element={<ContactUsPage />} />
				<Route key={location.key} path="/faq" element={<FAQ />} />
				<Route key={location.key} path="/integrations" element={<IntegrationPage />} />
				<Route key={location.key} path="/portfolio-classic" element={<PortfolioClassicPage />} />
				<Route key={location.key} path="/portfolio-grid" element={<PortfolioGridPage />} />
				<Route key={location.key} path="/pricing" element={<PricingPage />} />
				<Route key={location.key} path="/reset-password" element={<ResetPasswordPage />} />
				...
				<Route key={location.key} path="/single-blog" element={<SingleBlogPage />} />
				<Route key={location.key} path="/single-career" element={<SingleCareerPage />} />
				<Route key={location.key} path="/single-portfolio" element={<SinglePortfolioPage />} />
				<Route key={location.key} path="/single-service" element={<SingleServicePage />} />
				<Route key={location.key} path="/single-team" element={<SingleTeamPage />} />
				<Route key={location.key} path="/team" element={<TeamPage />} />
				<Route key={location.key} path="/testimonials" element={<TestimonialPage />} />
